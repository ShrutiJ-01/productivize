...
public class ProjectDao {
	...
	private Utilities projectUtilities = new Utilities();
	...
	public boolean insert(Project project) throws Exception {
		...
		project.id = projectUtilities.getRandomID(9999);
		if (project.id == -1) {
			// if all project ids in between 0 to 9999 are taken throw exception
			log.info("ProjectDao : Unable to generate a random Unique Id for project");
			throw new Exception("Unable to generate projectID");
		} else {
